...
class bbPress_Advanced_Statistics_Settings {
	...
	public function settings_assets () {
            ...
            wp_register_script( $this->parent->_token . '-settings-js', $this->parent->assets_url . 'js/settings' . $this->parent->script_suffix . '.js', array( 'farbtastic', 'jquery' ), '1.1' );
				...
				array(
					...
					'default'		=> 'on',
                                ...
                                array(
                                        ...
                                        'label'			=> __( 'bbPress Statistics Merge', 'bbpress-advanced-statistics' ),
                                        'description'	=> __( 'Include Thread Opening Posts into the Postcount?', 'bbpress-advanced-statistics' ),
                                        'type'			=> 'checkbox',
                                        'default'		=> 'on',
                                        'class'         => ''
                                )
